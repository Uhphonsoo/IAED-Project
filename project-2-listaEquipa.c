...
nodeEquipa* criaNodeEquipa(equipa* Equipa, nodeEquipa* next, nodeEquipa* previous) {
    nodeEquipa* novoNode;
    novoNode = (nodeEquipa*)malloc(sizeof(nodeEquipa)); /* ERRADO! DEVIA SER malloc(sizeof(struct(nodeEquipa)))
                                                NAO ESTA A ALOCAR O ESPACO CERTO */ 
                                                /* 10/abr/2021: mas nao e' a mesma coisa?? */
