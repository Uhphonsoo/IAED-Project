/*
 * Ficheiro: proj1_90398.c
 * Autor: Joao Afonso Silva, #90398
 * Descricao: 1o Projeto, de desenvolvimento de um sistema de logistica, em C para IAED
*/
...
/* Adiciona um produto a uma encomenda. Se o produto já existir na 
encomenda, adiciona a nova quantidade à quantidade existente */
void funcao_A(char comando[]) {
    int tamanho;
    int posProd;
    produto novoProduto;
